...
num_units = [2, 3, 4, 5, 6, 7, 8]  # Possible number of units for hidden layers
num_layers = [1]
act_funs = [Logistic, Tanh, ReLU, Leaky_ReLU]  # Hidden layer activation functions
learning_rates = [Learning_rate(0.01), Learning_rate(0.02), Learning_rate(0.03), Learning_rate(0.04), Linear_decay_learning_rate(0.04, 0.02, 50)]
regularization = [None]
lambda_values = [None]
momentum_values = [None, Momentum(0.5), Momentum(0.9), Nesterov_momentum(0.5), Nesterov_momentum(0.7), Nesterov_momentum(0.9)]
early_stopping = [Early_stopping(5, 0.00001), Early_stopping(7, 0.00001)]
num_epochs = [300]
