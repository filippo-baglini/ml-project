...
num_units = [2, 3, 4, 5]  # Possible number of units for hidden layers
num_layers = [1]
...
num_epochs = [300]
# num_units = [5]  # Possible number of units for hidden layers
# num_layers = [1]
# act_funs = [Leaky_ReLU]  # Hidden layer activation functions
# learning_rates = [Learning_rate(0.025)]
# losses = [MSE()]
# regularization = [None]
# lambda_values = [None]
# momentum_values = [None]
# early_stopping = [Early_stopping(12, 0.0001)]
# num_epochs = [300]
